  ...
  return (
    <>
      ...
      <div className="hidden md:block bg-white rounded-lg shadow-md p-6">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button className="mt-4 bg-orange-500 hover:bg-orange-600 text-white w-full">Proceed to Checkout</Button>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
      ...
      <div className="md:hidden fixed bottom-4 right-4 z-50">
        <Dialog open={isOrderListOpen} onOpenChange={setIsOrderListOpen}>
          <DialogTrigger asChild>
            <Button 
          ...
          <DialogContent className="sm:max-w-[425px] bg-white p-4 py-6">
            <DialogHeader>
